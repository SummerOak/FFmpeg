...
#define FFMPEG_CONFIGURATION "--cross-prefix=aarch64-linux-android- --sysroot=/Users/summer/soft/androidsdk/ndk/21.4.7075529//toolchains/llvm/prebuilt/darwin-x86_64/sysroot --prefix=/Users/summer/Github/FFmpeg/android --pkg-config= --enable-version3 --pkg-config=/usr/local/bin/pkg-config --arch=aarch64 --cpu=armv8-a --cc=aarch64-linux-android24-clang --cxx=aarch64-linux-android24-clang++ --target-os=android --enable-neon --enable-asm --enable-inline-asm --disable-decoders --disable-encoders --disable-demuxers --disable-muxers --disable-parsers --disable-bsfs --enable-protocols --disable-devices --disable-filters --disable-openssl --disable-xmm-clobber-test --disable-neon-clobber-test --disable-postproc --disable-doc --disable-zlib --disable-indevs --disable-htmlpages --disable-manpages --disable-podpages --disable-txtpages --disable-sndio --disable-schannel --disable-securetransport --disable-xlib --disable-cuda --disable-cuvid --disable-nvenc --disable-vdpau --disable-videotoolbox --disable-audiotoolbox --disable-appkit --disable-alsa --disable-cuda --disable-cuvid --disable-nvenc --disable-vdpau --enable-pthreads --enable-encoder=rawvideo --enable-demuxer=rtsp --enable-demuxer=sdp --enable-decoder=h264 --enable-protocol=rtp --enable-protocol=srtp --enable-parser=h264 --enable-filter=scale --enable-filter=crop --enable-outdev=callback --enable-cross-compile --enable-pic --enable-jni --enable-optimizations --enable-swscale --enable-static --enable-shared --enable-v4l2-m2m"
